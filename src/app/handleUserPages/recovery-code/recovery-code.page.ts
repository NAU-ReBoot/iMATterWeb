...
export class RecoveryCodePage implements OnInit {
    ...
    validateUser(enterCodeForm: FormGroup) {
        ...
        const newPassword = this.enterCodeForm.controls.recoveryPassword.value;
        console.log(newPassword);

        // currently provider_recovery_email contains both admin and provider recovery, will change variable name for
        // clarifaction in the future
